...
beforeEach(() => {
    vi.mocked(fetchBetVolume).mockResolvedValue({ home: 300, away: 200 })
})
...
describe("GameBetForm", () => {
    ...
    it("disables Place Bet until an outcome and a wager are set", async () => {
        ...
        render(<GameBetForm game={game} hasJoined={true} onPlaceBet={() => {}} />)
    ...
    it("reports the placed bet and locks the form once submitted", async () => {
        ...
        render(<GameBetForm game={game} hasJoined={true} onPlaceBet={onPlaceBet} />)
